...
const de = {
  ...
  auth: {
    ...
    registerCopy: "Erstellen Sie Ihr KLYKGO-Konto mit Ihrer E-Mail-Adresse und einem sicheren Passwort.",
    email: "E-Mail",
    password: "Passwort",
    ...
    checkEmail: "Fast geschafft. Wir haben Ihnen eine Bestätigungs-E-Mail gesendet. Bitte bestätigen Sie Ihre Adresse, um Ihr KLYKGO-Konto zu aktivieren.",
    registered: "Konto erfolgreich erstellt.",
    passwordMismatch: "Die Passwörter stimmen nicht überein.",
    passwordStrength: "Mindestens 8 Zeichen mit Gross- und Kleinbuchstaben, einer Zahl und einem Sonderzeichen.",
    ...
    providerNotEnabled: "Dieser Login-Anbieter ist in Supabase noch nicht aktiviert.",
    legalCopy: "Mit der Erstellung eines Kontos bestätigen Sie, dass Ihre Angaben korrekt sind und Sie die geltenden Datenschutz- und Vertragsbedingungen von KLYKGO akzeptieren.",
    ...
    close: "Schliessen", forgotPassword: "Passwort vergessen?", resetTitle: "Passwort zurücksetzen.", resetCopy: "Wir senden Ihnen einen Link, mit dem Sie ein neues Passwort festlegen können.", resetAction: "Link senden", resetSent: "Prüfen Sie Ihre E-Mails. Wir haben Ihnen einen Link zum Zurücksetzen des Passworts gesendet.", backToLogin: "Zurück zum Login", mfaTitle: "Zweiter Faktor", mfaHeading: "Code bestätigen.", mfaCopy: "Geben Sie den sechsstelligen Code aus Ihrer Authenticator-App ein.", mfaCode: "6-stelliger Code", mfaVerify: "Code bestätigen", mfaCancel: "Login abbrechen", mfaSent: "Ihre Authenticator-App wurde angefordert.", mfaInvalid: "Geben Sie einen gültigen sechsstelligen Code ein.", mfaVerified: "2FA bestätigt. Sie können jetzt Ihr Passwort ändern."
  },
  account: {
    kicker: "Kundenkonto", title: "Ihre Kontodaten.", intro: "Verwalten Sie Ihre persönlichen Angaben und die Sicherheit Ihres Zugangs.", profile: "Persönliche Angaben", firstName: "Vorname", lastName: "Nachname", email: "E-Mail", save: "Angaben speichern", saved: "Ihre Angaben wurden gespeichert.", password: "Passwort ändern", changePassword: "Passwort ändern", newPassword: "Neues Passwort", confirmPassword: "Neues Passwort bestätigen", passwordSaved: "Ihr Passwort wurde geändert.", security: "Sicherheit", twoFactor: "Zwei-Faktor-Authentifizierung", twoFactorEnabled: "Aktiviert", twoFactorDisabled: "Nicht aktiviert", enableTwoFactor: "2FA aktivieren", disableTwoFactor: "2FA deaktivieren", twoFactorRemoved: "Die Zwei-Faktor-Authentifizierung wurde deaktiviert.", twoFactorEnabledSuccess: "Die Zwei-Faktor-Authentifizierung wurde erfolgreich aktiviert.", noFactors: "Schützen Sie Ihr Konto mit einem zusätzlichen 6-stelligen Code aus Ihrer Authenticator-App.", twoFactorSetupTitle: "Authenticator-App einrichten", twoFactorSetupCopy: "Scannen Sie den QR-Code mit Google Authenticator, Microsoft Authenticator, Apple Passwörter, 1Password oder einer anderen TOTP-App. Geben Sie danach den aktuellen 6-stelligen Code ein.", twoFactorManualKey: "Manueller Einrichtungsschlüssel", twoFactorQrAlt: "QR-Code zur Einrichtung der Zwei-Faktor-Authentifizierung", twoFactorCode: "6-stelliger Code", twoFactorCodeInvalid: "Bitte geben Sie einen gültigen 6-stelligen Code ein.", twoFactorConfirm: "2FA bestätigen", twoFactorCancel: "Einrichtung abbrechen", logout: "Ausloggen", back: "Zur Startseite", required: "Bitte füllen Sie die Pflichtfelder aus.", passwordMismatch: "Die Passwörter stimmen nicht überein.", passwordLength: "Das Passwort muss mindestens 6 Zeichen enthalten.", genericError: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut."
  },
  phase2: {
    kicker: "Phase 02",
...
const en: Dictionary = {
  ...
  pricing: {
    ...
    priceOnRequest: "Price on Request", choose: "enquire"
  },
  plans: [
  ...
  auth: {
    ...
    registerCopy: "Create your KLYKGO account with your email address and a secure password.",
    email: "Email",
    password: "Password",
    ...
    loading: "...",
    working: "Please wait...",
    checkEmail: "Almost there. We sent you a confirmation email. Please verify your address to activate your KLYKGO account.",
    registered: "Account created successfully.",
    passwordMismatch: "The passwords do not match.",
    passwordStrength: "At least 8 characters with uppercase and lowercase letters, a number, and a special character.",
    ...
    providerNotEnabled: "This login provider is not enabled in Supabase yet.",
    legalCopy: "By creating an account, you confirm that your details are accurate and accept KLYKGO's applicable privacy and contractual terms.",
    ...
    close: "Close", forgotPassword: "Forgot password?", resetTitle: "Reset your password.", resetCopy: "We will send you a link to choose a new password.", resetAction: "Send reset link", resetSent: "Check your email. We sent you a password reset link.", backToLogin: "Back to login", mfaTitle: "Second factor", mfaHeading: "Confirm your code.", mfaCopy: "Enter the six-digit code from your authenticator app.", mfaCode: "Six-digit code", mfaVerify: "Verify code", mfaCancel: "Cancel login", mfaSent: "Your authenticator app has been requested.", mfaInvalid: "Enter a valid six-digit code.", mfaVerified: "2FA verified. You can now change your password."
  },
  account: {
    kicker: "Client account", title: "Your account details.", intro: "Manage your personal information and account security.", profile: "Personal information", firstName: "First name", lastName: "Last name", email: "Email", save: "Save details", saved: "Your details were saved.", password: "Change password", changePassword: "Change password", newPassword: "New password", confirmPassword: "Confirm new password", passwordSaved: "Your password was changed.", security: "Security", twoFactor: "Two-factor authentication", twoFactorEnabled: "Enabled", twoFactorDisabled: "Not enabled", enableTwoFactor: "Enable 2FA", disableTwoFactor: "Disable 2FA", twoFactorRemoved: "Two-factor authentication was disabled.", twoFactorEnabledSuccess: "Two-factor authentication was enabled successfully.", noFactors: "Protect your account with an additional 6-digit code from your authenticator app.", twoFactorSetupTitle: "Set up your authenticator app", twoFactorSetupCopy: "Scan the QR code with Google Authenticator, Microsoft Authenticator, Apple Passwords, 1Password or another TOTP app. Then enter the current 6-digit code.", twoFactorManualKey: "Manual setup key", twoFactorQrAlt: "QR code for setting up two-factor authentication", twoFactorCode: "6-digit code", twoFactorCodeInvalid: "Please enter a valid 6-digit code.", twoFactorConfirm: "Confirm 2FA", twoFactorCancel: "Cancel setup", logout: "Log out", back: "Back to home", required: "Please complete the required fields.", passwordMismatch: "The passwords do not match.", passwordLength: "The password must contain at least 6 characters.", genericError: "Something went wrong. Please try again."
  },
  phase2: {
...
const fr: Dictionary = {
  ...
  pricing: {
    ...
    priceOnRequest: "Prix sur demande", choose: "demander"
  },
  plans: [
  ...
  auth: {
    ...
    registerCopy: "Créez votre compte KLYKGO avec votre adresse e-mail et un mot de passe sécurisé.",
    email: "E-mail",
    ...
    checkEmail: "Presque terminé. Nous vous avons envoyé un e-mail de confirmation. Veuillez valider votre adresse pour activer votre compte KLYKGO.",
    registered: "Compte créé avec succès.",
    passwordMismatch: "Les mots de passe ne correspondent pas.",
    passwordStrength: "Au moins 8 caractères avec des lettres majuscules et minuscules, un chiffre et un caractère spécial.",
    ...
    providerNotEnabled: "Ce fournisseur de connexion n'est pas encore activé dans Supabase. Suivez le guide de configuration inclus dans le projet.",
    legalCopy: "En créant un compte, vous confirmez que vos informations sont exactes et acceptez les conditions applicables de confidentialité et de contrat de KLYKGO.",
    ...
    close: "Fermer", forgotPassword: "Mot de passe oublié ?", resetTitle: "Réinitialiser le mot de passe.", resetCopy: "Nous vous enverrons un lien pour choisir un nouveau mot de passe.", resetAction: "Envoyer le lien", resetSent: "Consultez vos e-mails. Nous vous avons envoyé un lien de réinitialisation.", backToLogin: "Retour à la connexion", mfaTitle: "Deuxième facteur", mfaHeading: "Confirmez votre code.", mfaCopy: "Saisissez le code à six chiffres de votre application d'authentification.", mfaCode: "Code à six chiffres", mfaVerify: "Vérifier le code", mfaCancel: "Annuler la connexion", mfaSent: "Votre application d'authentification a été sollicitée.", mfaInvalid: "Saisissez un code valide à six chiffres.", mfaVerified: "2FA confirmé. Vous pouvez maintenant changer votre mot de passe."
  },
  account: {
    kicker: "Compte client", title: "Vos données de compte.", intro: "Gérez vos informations personnelles et la sécurité de votre accès.", profile: "Informations personnelles", firstName: "Prénom", lastName: "Nom", email: "E-mail", save: "Enregistrer", saved: "Vos informations ont été enregistrées.", password: "Changer le mot de passe", changePassword: "Changer le mot de passe", newPassword: "Nouveau mot de passe", confirmPassword: "Confirmer le nouveau mot de passe", passwordSaved: "Votre mot de passe a été modifié.", security: "Sécurité", twoFactor: "Authentification à deux facteurs", twoFactorEnabled: "Activée", twoFactorDisabled: "Non activée", enableTwoFactor: "Activer la 2FA", disableTwoFactor: "Désactiver la 2FA", twoFactorRemoved: "L'authentification à deux facteurs a été désactivée.", twoFactorEnabledSuccess: "L'authentification à deux facteurs a été activée avec succès.", noFactors: "Protégez votre compte avec un code supplémentaire à 6 chiffres généré par votre application d'authentification.", twoFactorSetupTitle: "Configurer l'application d'authentification", twoFactorSetupCopy: "Scannez le QR code avec Google Authenticator, Microsoft Authenticator, Apple Passwords, 1Password ou une autre application TOTP. Saisissez ensuite le code actuel à 6 chiffres.", twoFactorManualKey: "Clé de configuration manuelle", twoFactorQrAlt: "QR code pour configurer l'authentification à deux facteurs", twoFactorCode: "Code à 6 chiffres", twoFactorCodeInvalid: "Veuillez saisir un code valide à 6 chiffres.", twoFactorConfirm: "Confirmer la 2FA", twoFactorCancel: "Annuler la configuration", logout: "Se déconnecter", back: "Retour à l'accueil", required: "Veuillez remplir les champs obligatoires.", passwordMismatch: "Les mots de passe ne correspondent pas.", passwordLength: "Le mot de passe doit contenir au moins 6 caractères.", genericError: "Une erreur s'est produite. Veuillez réessayer."
  },
  phase2: {
