...
const de = {
  ...
  account: {
    kicker: "Kundenkonto", title: "Ihre Kontodaten.", intro: "Verwalten Sie Ihre persönlichen Angaben und die Sicherheit Ihres Zugangs.", profile: "Persönliche Angaben", firstName: "Vorname", lastName: "Nachname", email: "E-Mail", save: "Angaben speichern", saved: "Ihre Angaben wurden gespeichert.", password: "Passwort ändern", changePassword: "Passwort ändern", newPassword: "Neues Passwort", confirmPassword: "Neues Passwort bestätigen", passwordSaved: "Ihr Passwort wurde geändert.", security: "Sicherheit", twoFactor: "Zwei-Faktor-Authentifizierung", twoFactorEnabled: "Aktiviert", twoFactorDisabled: "Nicht aktiviert", disableTwoFactor: "2FA deaktivieren", twoFactorRemoved: "Die Zwei-Faktor-Authentifizierung wurde deaktiviert.", noFactors: "Für dieses Konto ist keine 2FA eingerichtet.", logout: "Ausloggen", back: "Zur Startseite", required: "Bitte füllen Sie die Pflichtfelder aus.", passwordMismatch: "Die Passwörter stimmen nicht überein.", passwordLength: "Das Passwort muss mindestens 6 Zeichen enthalten.", genericError: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut."
  },
  phase2: {
    kicker: "Phase 02",
...
const en: Dictionary = {
  ...
  account: {
    kicker: "Client account", title: "Your account details.", intro: "Manage your personal information and account security.", profile: "Personal information", firstName: "First name", lastName: "Last name", email: "Email", save: "Save details", saved: "Your details were saved.", password: "Change password", changePassword: "Change password", newPassword: "New password", confirmPassword: "Confirm new password", passwordSaved: "Your password was changed.", security: "Security", twoFactor: "Two-factor authentication", twoFactorEnabled: "Enabled", twoFactorDisabled: "Not enabled", disableTwoFactor: "Disable 2FA", twoFactorRemoved: "Two-factor authentication was disabled.", noFactors: "No 2FA factor is set up for this account.", logout: "Log out", back: "Back to home", required: "Please complete the required fields.", passwordMismatch: "The passwords do not match.", passwordLength: "The password must contain at least 6 characters.", genericError: "Something went wrong. Please try again."
  },
  phase2: {
