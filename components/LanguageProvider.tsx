...
const de = {
  ...
  auth: {
    ...
    socialLabel: "Anmeldung mit einem externen Konto",
    login: "Login",
    register: "Registrieren",
    loginTitle: "Willkommen zurück.",
    registerTitle: "Konto erstellen.",
    loginCopy: "Wählen Sie Ihr bevorzugtes Konto oder melden Sie sich klassisch mit E-Mail und Passwort an.",
    registerCopy: "Erstellen Sie Ihr KLYKGO-Konto mit Ihrem bevorzugten Anbieter oder mit E-Mail und Passwort.",
    continueGoogle: "Mit Google fortfahren",
    continueMicrosoft: "Mit Microsoft fortfahren",
    continueApple: "Mit Apple fortfahren",
    continueYahoo: "Mit Yahoo fortfahren",
    redirecting: "Weiterleitung...",
    providerNote: "Gmail läuft über Google, Outlook und Hotmail über Microsoft, iCloud über Apple. Yahoo ist als eigener OAuth-Anbieter vorbereitet.",
    ...
    socialError: "Die Anmeldung mit diesem Anbieter konnte nicht gestartet werden. Bitte versuchen Sie es erneut.",
    providerNotEnabled: "Dieser Login-Anbieter ist in Supabase noch nicht aktiviert. Folgen Sie der Setup-Anleitung im Projekt.",
...
const en: Dictionary = {
  ...
  auth: {
    ...
    socialLabel: "Sign in with an external account",
    login: "Login",
    register: "Register",
    loginTitle: "Welcome back.",
    registerTitle: "Create your account.",
    loginCopy: "Choose your preferred account or sign in with email and password.",
    registerCopy: "Create your KLYKGO account with your preferred provider or with email and password.",
    continueGoogle: "Continue with Google",
    continueMicrosoft: "Continue with Microsoft",
    continueApple: "Continue with Apple",
    continueYahoo: "Continue with Yahoo",
    redirecting: "Redirecting...",
    providerNote: "Gmail uses Google, Outlook and Hotmail use Microsoft, iCloud uses Apple. Yahoo is prepared as a custom OAuth provider.",
    ...
    socialError: "We could not start sign-in with this provider. Please try again.",
    providerNotEnabled: "This login provider is not enabled in Supabase yet. Follow the setup guide included with the project.",
...
const fr: Dictionary = {
  ...
  auth: {
    ...
    socialLabel: "Connexion avec un compte externe",
    login: "Connexion",
    register: "S'inscrire",
    loginTitle: "Bon retour.",
    registerTitle: "Créer votre compte.",
    loginCopy: "Choisissez votre compte préféré ou connectez-vous avec votre e-mail et votre mot de passe.",
    registerCopy: "Créez votre compte KLYKGO avec votre fournisseur préféré ou avec votre e-mail et votre mot de passe.",
    continueGoogle: "Continuer avec Google",
    continueMicrosoft: "Continuer avec Microsoft",
    continueApple: "Continuer avec Apple",
    continueYahoo: "Continuer avec Yahoo",
    redirecting: "Redirection...",
    providerNote: "Gmail passe par Google, Outlook et Hotmail par Microsoft, iCloud par Apple. Yahoo est préparé comme fournisseur OAuth personnalisé.",
    ...
    socialError: "Impossible de démarrer la connexion avec ce fournisseur. Veuillez réessayer.",
